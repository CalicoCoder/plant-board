  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content onOpenAutoFocus={(event) => {event.preventDefault()}}
        className="z-40 overflow-scroll animate-scaleIn origin-[0%_0%] fixed top-2/4 left-2/4 -translate-y-2/4 -translate-x-2/4 max-h-full rounded-md bg-brown-texture w-v90 lg:w-v50">
        {props.children}
